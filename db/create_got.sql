...
CREATE TABLE got_char_spec (
	...
	CONSTRAINT fk_char_spec_char FOREIGN KEY (char_id) REFERENCES got_character (id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE got_char_ally (
	...
	CONSTRAINT fk_char_ally_char FOREIGN KEY (char_id) REFERENCES got_character (id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE got_house_ally (
	...
	CONSTRAINT fk_house_ally_house FOREIGN KEY (house_id) REFERENCES got_character(id) ON DELETE RESTRICT ON UPDATE CASCADE,
